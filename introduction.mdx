...
1. **Conversational Chat Apps** _These are similar to Open AI GPTs enabling you to build single agent chat apps except they can use any LLM, can access a library of tools as well as retrieve knowledge from hundreds of data sources_
2. **Process Apps** _These enable you to automate processes by allocating goals and tasks for agents to complete._
...
So we decided to power the end-to-end creation of these two apps the platform, saves developers time, by coming with all the components required.
