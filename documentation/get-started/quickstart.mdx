...
<AccordionGroup>
  <Accordion icon="github" title="1. Clone the repository locally">
  ...
  <Accordion icon="rectangle-terminal" title="2. install.sh">
    <Warning>
    For now there is a reliance on GCP for Bucket storage to store files.
    (We will add AWS S3 and Local Disk storage in future releases.)
    </Warning>
  ...
  <Accordion icon="desktop" title="3. Go to localhost:3000">
