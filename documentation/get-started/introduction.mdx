...
<Card title="Conversational Chat Apps" icon="link" iconType="duotone" color="#ca8b04" href="/demo-chat-rag-bigquery">
...
<Frame caption="Organizational and Functional Map">
    <img src="/images/functional-map.png" alt="Diagram of the functional structure of the app showing connections between teams, users, permissions, and system components in Agent Cloud"/>
</Frame>
...
<Frame>
    <img src="/images/updated-end-to-end-RAG-a-a-S.png" alt="End to End RAG-a-a-S by Agent Cloud" />
</Frame>
...
<Frame caption="Augmented Human/AI teams">
    <img src="/images/ai-teams.png" alt="Augmented Human/AI teams"/>
</Frame>

<Frame caption="Augmented Human/AI tasks">
    <img src="/images/ai-tasks.png" alt="Augmented Human/AI tasks"/>
</Frame>
